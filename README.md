# interactive-demo-terminal-simulator
Simulates a shell terminal in order to create Interactive Demos.

![Example](screenshot.gif)


Companies wishing to create interactive demos of their product using systems such as Navattic.com are often struggling to create more technical demonstrations, especially ones that include an shell terminal. Options exist, including Butterfly, a web-shell, but are more complicated to use.
